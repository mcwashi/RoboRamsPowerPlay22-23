...
@Autonomous(name = "8648 Blue Right DSP", group = "Concept")
@Disabled
public class Frenzy8648AuBlueRightDSPTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(robot.TURN_SPEED, 48, -48, -48, 48, 7);

        /*
        encoderDrive(robot.TURN_SPEED, 36, -36, 36, -36, 9);
        encoderDrive(robot.DRIVE_SPEED, 2.3, 2.3,2.3, 2.3, 3);
        encoderDrive(robot.TURN_SPEED, 6, -6, 6, -6, 6);
        encoderDrive(robot.DRIVE_SPEED, -18.0, -18.0,-18.0, -18.0, 5);
        encoderDrive(robot.TURN_SPEED, -4, 4, 4, -4, 6);
